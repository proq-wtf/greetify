...
GlobalFonts.registerFromPath("node_modules/greetify/build/structures/font/Snasm-W05-Regular.ttf", "nig")
GlobalFonts.registerFromPath("node_modules/greetify/build/structures/font/Rajdhani-Medium.ttf", "medium")
GlobalFonts.registerFromPath("node_modules/greetify/build/structures/font/Rajdhani-Bold.ttf", "bold")

const defaultAssets = {
    background: "https://t4.ftcdn.net/jpg/04/53/63/07/360_F_453630770_N9UkWkDVZGC9AA91ohlKhdjDMMNhBQbU.jpg",
    shadow: "https://s6.imgcdn.dev/Zqmpi.png",
    gradient: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/HD_transparent_picture.png/1280px-HD_transparent_picture.png"
}
...
class welcomeCard {
  ...
  <svg width="1280" height="538" viewBox="0 0 1280 538" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M0 0H1280V229.5C1280 399.88 1141.88 538 971.5 538H308.5C138.12 538 0 399.88 0 229.5V0Z" fill="#${this.color}" fill-opacity="0.001" />
  </svg>
`;
      ...
      //  ctx.fillText(`${this.username}`.toUpperCase(), centerX, centerY + 80)
      ...
      //  ctx.font = `76px bold`
     //   ctx.textAlign = 'center';
     //   ctx.fillText(`${this.title}`.toUpperCase(), centerX, centerY)

        ctx.fillStyle = gradient
        ctx.font = `70px medium`
        ctx.textAlign = 'center';
        ctx.fillText(`${this.message}`.toUpperCase(), centerX, centerY + 270);
